        ...
        <div className="tooltip programsortby-tooltip">
          ...
          <div className="btn-group bootstrap-select form-control program-sort-by disabled">
            ...
            >
              ...
              <option value="TuitionFeeDesc">Tuition Fee - High to Low</option>
              <option value="TuitionFeeAsc">Tuition Fee - Low to High</option>
              ...
              <div className="col-lg-8 col-md-8 col-sm-8 courseDetails">
                <div style={{ float: "left", width: "80%" }}>
                  ...
                  >
                    ...
                    >
                      BSc (Hons) Actuarial Mathematics (International Foundation
                      Year)
                    </a>
                  </h3>
                </div>
                      ...
                      <div className="col-lg-8 col-md-8 col-sm-8 courseDetails">
                        <div style={{ float: "left", width: "80%" }}>
                          ...
                          >
                            ...
                            >
                              BA (Hons) Business Management and the Human
                              Resource (International Foundation Year)
                            </a>
                          </h3>
                        </div>
                        <div className="font-size13 clearfix">
                              ...
                              <div className="col-lg-8 col-md-8 col-sm-8 courseDetails">
                                <div style={{ float: "left", width: "80%" }}>
                                  ...
                                  >
                                    ...
                                    >
                                      BA (Hons) Childhood Studies (International
                                      Foundation Year)
                                    </a>
                                  </h3>
                                </div>
                                  ...
                                  <div className="col-lg-8 col-md-8 col-sm-8 courseDetails">
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        >
                                          BA (Hons) Criminal Justice and
                                          Criminology (International Foundation
                                          Year)
                                        </a>
                                      </h3>
                                    </div>
